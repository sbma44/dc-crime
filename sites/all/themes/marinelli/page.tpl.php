...
<?php } ?>
  ...
  <div class="content">
   ...
   <div id="primary" style=<?php print '"width:'.marinelli_width( $sidebar_left, $sidebar_right).'px;">' ?>
   ...
   <?php if ($mission): print '<div id="sitemission"><p>'. $mission .'</p></div>'; endif; ?>
		...
		elseif(!$suppress_title) {print '<h1'. ($tabs ? ' class="with-tabs"' : '') .'>'. $title .'</h1>';  /* otherwise use <h1> for node title */
		 }
